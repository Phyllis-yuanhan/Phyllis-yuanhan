...
-  [Predictive Marketing Analytics: Promotion Effectiveness Analysis with Machine Learning](https://github.com/Phyllis-yuanhan/Promotion-Effectiveness-Analysis-with-Machine-Learning): This project develops a predictive model using historical transaction and promotion response data to forecast customer reactions to offers. Evaluated with the ROC-AUC, precision, and recall metrics, the XGBoost classifier was chosen for its superior performance. Feature engineering and hyperparameter tuning enhanced the model, with future improvements aimed at exploring advanced features and deeper optimization for better accuracy and predictive power.

- [Advanced Earnings Prediction: Enhanced Models and Accuracy Assessment](https://github.com/Phyllis-yuanhan/Advanced-Earnings-Prediction): This group project integrates Compustat and IBES data to refine earnings forecasting models including HVZ, earnings persistence, and residual income. Analysis spans 2010-2019 data for model comparison, extending to 2020-2022 for accuracy assessment. Additional factors, extracted from the Compustat dataset, are integrated to enhance the best-performing model. Forecasts for 2020 EPS are compared with analyst predictions, and top-performing firms for 2023 earnings growth are identified and pitched based on qualitative factors.
